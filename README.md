...
| $helloIDUserCorrelationProperty | String value of name of the property of HelloID users to match to Exchange Online users                                      | The default value ("username")                                                                                                                                                                                                                                      |
